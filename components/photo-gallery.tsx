...
const galleryImages = [
  ...
  },
  {
    ...
    alt: "Male lion with magnificent mane and lioness standing on dirt road directly in front of beige safari vehicle (Toyota Land Cruiser, license KBU 053K) with tourists observing from open pop-up roof",
    category: "Wildlife",
